...
function encryptData($input, $key_seed = "Fp1dLHzGexhwKy8Ht2GzvmXQ") {
    $input = trim($input);
...
function decrypt($input, $key_seed = "Fp1dLHzGexhwKy8Ht2GzvmXQ") {
...
//ID tài khoản của đại lý
    $AccID = "5b710ee884ae8c224bbc4ef8";
//Mã dịch vụ, sản phẩm
