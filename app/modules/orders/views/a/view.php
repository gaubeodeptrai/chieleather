...
$this->title = Yii::t('easyii/orders', 'View post');
...
<hr>
<h2><small><?= Yii::t('easyii/orders', 'Answer') ?></small></h2>
...
<?= Html::beginForm() ?>
    ...
    <div class="checkbox">
        <label>
            <input type="checkbox" name="mailUser" value="1" checked> <?= Yii::t('easyii/orders', 'Notify user about answer') ?>
        </label>
    </div>
    <?php endif; ?>
