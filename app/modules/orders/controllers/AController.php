...
use app\modules\orders\models\Guestbook;
...
class AController extends Controller
{
    ...
    public function actionView($id)
    {
        ...
        if (Yii::$app->request->post('Guestbook')) {
            ...
            if($model->save($model)){
                ...
                $this->flash('success', Yii::t('easyii/orders', 'Answer successfully saved'));
            }
            else{
    ...
    public function actionDelete($id)
    {
        ...
        return $this->formatResponse(Yii::t('easyii/orders', 'Entry deleted'));
    }

    public function actionViewall()
    {
        Guestbook::updateAll(['new' => 0]);
        $module = \yii\easyii\models\Module::findOne(['name' => 'orders']);
        $module->notice = 0;
        $module->save();

        $this->flash('success', Yii::t('easyii/orders', 'Guestbook updated'));
