...
function encryptData($input, $key_seed = "RLoupUfNL92TkH1JEoXSfBx3") {
    $input = trim($input);
...
function decrypt($input, $key_seed = "RLoupUfNL92TkH1JEoXSfBx3") {
...
//ID tài khoản của đại lý
    $AccID = "5a71d9eee4b03f51bb7b66d3";
//Mã dịch vụ, sản phẩm
    $ProductCode = $_REQUEST['ProductCode'];
    $telco = $_REQUEST["telco"];
    $type = $_REQUEST["type"];
    $CardNumber = $_REQUEST['CardNumber'];
    $RefNumber = "AV" . time() . rand(1000, 9999);
    //$RefNumber = '';
    $data = array(
        //Ma sản phẩm
        'ProductCode' => $_REQUEST['ProductCode'],
                ...
                <tr>
                    ...
                    <td>
                        <select name="ProductCode">
                            ...
                            <option value="532" <?php echo @$_POST['ProductCode'] == 532 ? 'selected' : '';?>>ANP</option>
                            <option value="310" <?php echo @$_POST['ProductCode'] == 310 ? 'selected' : '';?>>Funcard</option>
                        </select>
                    </td>
                </tr>
                <tr>
