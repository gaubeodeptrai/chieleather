...
function encryptData($input, $key_seed = "ESReRKh4zaqlFAB33GUH84wA") {
    $input = trim($input);
...
function decrypt($input, $key_seed = "ESReRKh4zaqlFAB33GUH84wA") {
...
//ID tài khoản của đại lý
    $AccID = "5bcf1b6784aede2797f6aca1";
//Mã dịch vụ, sản phẩm
                ...
                <tr>
                    ...
                    <td>
                        <select name="ProductCode">
							...
							<option value="532" <?php echo @$_POST['ProductCode'] == 532 ? 'selected' : '';?>>ANPAY</option>
                        </select>
                    </td>
                </tr>
                <tr>
